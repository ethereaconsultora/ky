...
- ✅ Auth EC: login propio con **email + contraseña** (reemplaza el OTP por mail). Sólo entran los emails de la tabla
  `usuarios_habilitados` (la maneja el admin desde Supabase); cada uno crea su contraseña con un link a su casilla (DD-13, migración `0010`).
