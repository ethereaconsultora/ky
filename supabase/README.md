...
| 0010 | Lista de usuarios habilitados (`usuarios_habilitados`) + candado en `auth.users` + marca `ky_activo` + sincronización de rol/nombre. **Es lo que maneja el admin para dar acceso.** |
